...
class Tester(object):
    ...
    def result(self, epoch, time, loss_total, MSE_dev, MSE_test, file_name):
        with open(file_name, 'a') as f:
            result_list = [epoch, time, loss_total, MSE_dev, MSE_test]
...
if __name__ == "__main__":
    ...
    file_result = '../../output/result/MSE--' + setting + '.txt'
    with open(file_result, 'w') as f:
        f.write('Epoch\tTime(sec)\tLoss(MSE)\tMSE_dev(unit)\tMSE_test(unit)\n')

    file_model = '../../output/model/' + setting

    print('Epoch Time(sec) Loss MSE_dev MSE_test')
    ...
    for epoch in range(iteration):
        ...
        tester.result(epoch, time, loss_total, MSE_dev, MSE_test, file_result)
        tester.save_model(model, file_model)

        print(epoch, time, loss_total, MSE_dev, MSE_test)
